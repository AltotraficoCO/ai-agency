...
- ENLAZA EN EL BLOG: cuando la entrada esté creada y verificada, llama a wp_enlazar_entrada_en_blog con su id y un extracto de 1-2 frases, y revisa después la página del blog con navegador_ver_pagina.
