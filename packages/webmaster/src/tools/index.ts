/**
 * El registro del Webmaster: 40 herramientas definidas UNA sola vez.
 *
 * 23 de WordPress (incluidas `sitio_salud` y `verificar_http`), 10 del
 * conector estándar, 6 de navegador y referencias, y `pedir_aprobacion`, que es
 * como el agente le pregunta algo al cliente. Los adaptadores a AI SDK y a MCP
 * viven en `@strappy/tools` y salen de estas mismas definiciones: no hay una
 * segunda copia que pueda divergir.
 */
